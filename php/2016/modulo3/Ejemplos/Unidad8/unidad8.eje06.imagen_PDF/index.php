...
try {
    ...
    $pdf->set_info("CustomField", "Ejemplo 6 - Unidad 8 - Curso de Iniciación PHP 5");
    ...
    // Tomamos el tamaño (ancho y alto) de la imagen.
    $ancho=$pdf->get_value("imagewidth",$imagen);
    $alto=$pdf->get_value("imageheight",$imagen);
    
    // Generamos una página que tenga las mismas dimensiones
    // que la imagen.
	...
	while($paginas-- > 0)  // Abrimos un bucle para crear las dos páginas.
 	{
        ...
        // Escribimos el título de la página.
        $pdf->show_xy("Curso de Iniciación de PHP 5",135,530);
    ...
    die("Ocurrió un Excepción PDFlib en el ejemplo imagen:\n" .
