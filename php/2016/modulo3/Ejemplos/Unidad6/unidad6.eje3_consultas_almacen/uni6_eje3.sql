...
# tabla clientes cuyo año de la fecha de alta sea posterior a 2013.

SELECT nombre,tipo FROM clientes WHERE year(alta)>2013;
...
# Misma consulta anterior con INNER JOIN
SELECT * FROM clientes
INNER JOIN compras ON clientes.codigo = compras.codigo_cliente;

# Usando LEFT JOIN para realizar una combinación externa de tablas
SELECT * FROM clientes
