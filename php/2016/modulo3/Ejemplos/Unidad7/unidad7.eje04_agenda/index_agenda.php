<HTML>
<HEAD><TITLE>Ejemplo 4 - Unidad 7 - Curso Iniciación de PHP 5 - Agenda de contactos con MySQL</TITLE>
	<STYLE  TYPE="text/css">
		<!--
		input
			{
  ...
  echo "<CENTER><P>
  		...
  		<TR>
  		   ...
  		   <FORM name='form1' METHOD='POST' 
  		   		ACTION=\"index_agenda.php?operacion=buscar\">
  		   	<FONT size ='-1'>
  		   ...
  		   <FORM name='form2' METHOD='POST' ACTION=
  		   		\"index_agenda.php?operacion=introduce&ver=0
  		   		&nume=0#ancla\">
  		   	<FONT size ='-1'>
  		   ...
  		   <FORM name='form3' METHOD='POST' 
  		   		ACTION=\"index_agenda.php?operacion=listado\">
  		   	<FONT size ='-1'><BR>
