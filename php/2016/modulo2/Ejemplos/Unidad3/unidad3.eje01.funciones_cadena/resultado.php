<HTML>
<HEAD>
<TITLE>Ejemplo 1b - Unidad 3 - Curso Iniciación de PHP 5</TITLE>
</HEAD>
<BODY>
...
//           strrpos(), strrchr() y strstr() y str_replace()
...
echo "<H1><CENTER>Función str_replace()</H1></CENTER><P>";
echo "La instrución <B> \$nueva_frase = str_replace(\$no_saludable, \$saludable, \$frase)
     	</B> devuelve <FONT size='3'>
       	<B>\"";
...
// Para que el código fuente de los ejemplos del curso sea compatible en distintos sistemas operativos
// está codificado con el juego de caracteres UTF8. Desgraciadamente la función strrev no está disponible 
// para este tipo de caracteres y es necesario utilizar la función siguiente.
...
echo "La instrucción <B>\"strrev(\"Los días perdidos\")\" devuelve: 
		<FONT size='3'>\"".utf8_strrev("Los días perdidos").
     	"\"<P></FONT></B>";

echo "La instrucción <B>\"strrev(\"Del salón en el ángulo 
		oscuro...\")\" devuelve: <FONT size='3'>\"".
     	utf8_strrev("Del salón en el ángulo oscuro...").
     	"\"<P></FONT></B>";
...
// Nota: esta función tampoco es compatible con UTF8 pero hemos definido la cadena 
// sin caracteres especiales para que funcione correctamente.
$cadena="Lo que el viento se llevaba";
