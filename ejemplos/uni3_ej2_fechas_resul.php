<HTML>
<HEAD>
  <TITLE>Curso PHP 5 - Unidad 3 - Ejemplo 2b</TITLE>
...
echo "¿Es válida la fecha <B>31 de junio de 2000</B>?&nbsp;&nbsp;&nbsp;";
echo "<FONT face='Georgia, Times New Roman' size='4'><B>";
if (checkdate(6,31,2000))
   echo "Sí";
else
   echo "No";
echo "<P></font face='Georgia, Times New Roman' size='4'></B>";

echo "¿Es válida la fecha <B>30 de noviembre de 2001</B>?&nbsp;&nbsp;&nbsp;";
echo "<FONT face='Georgia, Times New Roman' size='4'><B>";
if (checkdate(11,30,2001))
   echo "Sí";
else
   echo "No";
echo "<P></font face='Georgia, Times New Roman' size='4'></B>";
...
$momento=mktime(10,15,20,10,2,05);
echo "El momento que corresponde a la fecha <B>2 de octubre de
        2005, a las 10 horas, 15 minutos y 20 segundos</B>
...
echo "Asignamos a <B>\$momento</B> el momento que corresponde al
        <B>2 de octubre de 2005 10:15:20</B> obtenido con
